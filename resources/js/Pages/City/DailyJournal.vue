...
<style scoped>
.daily-paper-page{max-width:1280px}.daily-paper__toolbar{display:flex;margin-bottom:18px;align-items:center;justify-content:space-between;gap:16px;color:#6f6073;font-size:13px}.daily-paper{overflow:hidden;border:1px solid rgb(70 50 78/12%);border-radius:26px;background:#fcf8f2;box-shadow:0 18px 45px rgb(70 50 78/10%)}.daily-paper__masthead{display:grid;padding:28px 40px 24px;border-bottom:4px double rgb(70 50 78/25%);text-align:center}.daily-paper__masthead>span{color:#486852;font-size:12px;font-weight:900;letter-spacing:.16em;text-transform:uppercase}.daily-paper__masthead h1{margin:3px 0 5px;color:#46324e;font-family:"Bricolage Grotesque",sans-serif;font-size:clamp(38px,6vw,76px);line-height:.95}.daily-paper__masthead time{color:#6f6073;font-weight:700;text-transform:capitalize}.daily-paper__section{padding:34px 40px 42px}.daily-paper__section-title{max-width:720px}.daily-paper__section-title>span{color:#d6a84a;font-size:12px;font-weight:900;letter-spacing:.14em;text-transform:uppercase}.daily-paper__section-title h2{margin:3px 0 6px;color:#46324e;font-family:"Bricolage Grotesque",sans-serif;font-size:clamp(34px,4vw,54px)}.daily-paper__section-title p{margin:0;color:#6f6073}.daily-paper__deaths{display:grid;margin-top:28px;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.daily-paper__notice{display:grid;padding:22px;border:1px solid rgb(70 50 78/10%);border-radius:18px;gap:17px;background:#f8f3ec}.daily-paper__notice>div{display:flex;align-items:center;gap:13px}.daily-paper__symbol{display:grid;width:42px;height:42px;border-radius:50%;place-items:center;color:#46324e;background:#f0e6d8;font-size:21px}.daily-paper__notice h3{margin:0;font-family:"Bricolage Grotesque",sans-serif;font-size:24px}.daily-paper__identity--female{color:#b96f7d}.daily-paper__identity--male{color:#587f92}.daily-paper__notice p{margin:0}.daily-paper__notice>div p,.daily-paper__notice time{color:#6f6073;font-size:13px}.daily-paper__cause{padding-top:15px;border-top:1px solid rgb(70 50 78/10%);color:#46324e;font-weight:700}.daily-paper__empty{margin-top:28px;padding:30px;border-radius:18px;color:#46324e;background:#f4eee5;text-align:center}.daily-paper__empty p{margin:5px 0 0;color:#6f6073}@media(max-width:760px){.daily-paper__toolbar{align-items:flex-start;flex-direction:column}.daily-paper__masthead,.daily-paper__section{padding-right:22px;padding-left:22px}.daily-paper__deaths{grid-template-columns:1fr}}
</style>
