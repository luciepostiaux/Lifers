...
<template>
    <AppLayout title="Communauté" :money="money">
        ...
        <div v-if="showCreateGroup" class="community-modal-backdrop" @click.self="closeCreateGroup">
            <AccessibleDialog class="community-modal" labelledby="create-group-title" @close="closeCreateGroup">
        ...
        <div v-if="showAddMembers" class="community-modal-backdrop" @click.self="closeAddMembers">
            <AccessibleDialog class="community-modal" labelledby="add-members-title" @close="closeAddMembers">
...
.community-kicker{color:#486852;font-size:10px;font-weight:800;letter-spacing:.11em;text-transform:uppercase}
...
.community-icon-button{display:inline-grid;width:44px;height:44px;border:0;border-radius:13px;place-items:center;color:#46324e;background:#d6a84a;box-shadow:0 7px 16px rgb(70 50 78/11%);font-size:25px;font-weight:600;line-height:1}
...
.conversation-section{padding:10px 0 8px}.conversation-section>h2,.conversation-section__heading h2{margin:0;color:rgb(70 50 78/78%);font-size:10px;font-weight:800;letter-spacing:.09em;text-transform:uppercase}.conversation-section>h2,.conversation-section__heading{padding:0 9px 8px}.conversation-section__heading{display:flex;align-items:center;justify-content:space-between}.conversation-section__heading button{min-height:44px;border:0;color:#6a4d18;background:transparent;font-size:11px;font-weight:800}
