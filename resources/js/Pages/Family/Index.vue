...
.family-button,.family-name-form input,.family-name-form select,.family-name-form .family-button,.family-child-care button{min-height:44px}.family-favorite{width:44px;height:44px}
</style>
