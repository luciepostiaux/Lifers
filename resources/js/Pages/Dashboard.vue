    ...
    <AppLayout title="Dashboard">
        ...
        <div class="md:pt-24">
            <div class="flex flex-col gap-4 md:flex-row mb-4 w-full h-full">
                ...
                >
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 h-full">
                        <div class="flex flex-col">
                            ...
                            />
                            <div
                                class="mt-2 text-sm font-bold py-2 px-4 rounded"
                            >
                                <h1 v-if="perso" class="text-xl font-semibold">
                                    {{ perso.first_name }}
                                    {{ perso.last_name }}
                                </h1>
                        ...
                        <div class="flex flex-col justify-between gap-4 py-4">
                            <Link :href="route('study.index')">
                                <div
                                    class="mt-2 text-sm bg-gray-400 text-white font-bold py-2 px-4 rounded hover:bg-gray-700"
                                >
                            ...
                            <Link :href="route('doctor.index')">
                                <div
                                    class="mt-2 text-sm bg-gray-400 text-white py-2 px-4 rounded hover:bg-gray-700"
                                >
                ...
                <div
                    class="flex-1 md:flex-auto md:w-2/5 lg:w-2/5 bg-white p-8 rounded-lg shadow-md mb-4 md:mb-0"
                >
            ...
            <div
                class="flex items-center justify-between bg-white p-8 rounded-lg shadow-md"
            >
                <div>
                    <p class="flex-grow">
