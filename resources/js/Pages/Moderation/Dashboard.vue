    ...
    <AppLayout title="Modération" :money="money">
        <div class="moderation-page">
            ...
            <nav class="moderation-tabs" aria-label="Sections de modération">
                <button v-for="tab in tabs" :key="tab.id" type="button" :class="{ 'is-active': activeTab === tab.id }" :aria-pressed="activeTab === tab.id" @click="activeTab = tab.id">
        ...
        <div v-if="editedProfile" class="moderation-modal-backdrop" @click.self="closeProfileEditor">
            <AccessibleDialog class="moderation-modal" labelledby="moderation-editor-title" @close="closeProfileEditor">
...
.moderation-tabs button,.moderation-card>header button,.moderation-list-item>button,.moderation-images button,.moderation-modal>header>button{min-width:44px;min-height:44px}.moderation-modal>header>button{width:44px;height:44px}
</style>
