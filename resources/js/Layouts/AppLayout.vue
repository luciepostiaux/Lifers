...
<template>
    <div
        class="flex justify-center bg-emerald-950 h-screen tracking-wide leading-relaxed"
    >
        <Head :title="title" />

        <Banner />

        <div id="sidebar" class="hidden lg:flex min-h-screen">
            <nav
        ...
        <div class="absolute top-0 right-0 p-4 z-50 lg:hidden">
            <button
        ...
        <!-- Menu réactif (à gauche ou à droite selon préférence) -->
        <div
            :class="{ block: isSidebarOpen, hidden: !isSidebarOpen }"
            class="lg:hidden fixed inset-0 bg-emerald-800/90 backdrop-blur-md z-40"
        >
            <ul class="flex flex-col gap-2 mt-10">
                <li
                    class="group py-2 transition-colors duration-200 ease-in-out"
                >
                    <ResponsiveNavLink
                        :href="route('dashboard')"
                        class="flex items-center px-4 relative"
            ...
            <ul class="flex flex-col gap-2 mt-10">
                ...
                <li
                    class="group py-2 transition-colors duration-200 ease-in-out ml-4"
                >
                    <button @click="logout" class="flex items-center px-4 py-2">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="currentColor"
        ...
        <div class="flex flex-col justify-center items-center w-full h-full">
            <div
                class="lg:w-[85vw] lg:h-[85vh] hide-scrollbar custom-scrollbar overflow-y-auto text-gray-200 shadow-lg lg:rounded-lg m-auto bg-cover bg-center"
                style="background-image: url('/images/places/ville.webp')"
            >
                <main class="m-4 md:m-8">
                    <slot />
                </main>
            </div>
            <footer class="text-gray-200 text-sm my-4">
                <div
                    class="container mx-auto flex justify-between items-center space-x-2"
                >
